...
export class Tag {
    ...
    static readonly MySQL = new Tag('MySQL', '#197189' );
    static readonly ORACLE = new Tag('Oracle', '#451230' );
    static readonly JEST = new Tag('Jest', '#5a7581');
    static readonly CMS = new Tag('CMS', '#192129');
    static readonly JIRA = new Tag('Jira', '#192129');
    static readonly CUCUMBER = new Tag('Cucumber', '#355158');
    static readonly CICD = new Tag('CICD', '#4a6a77');
    static readonly GHERKINS = new Tag('Gherkins', '#4a6a77');
    static readonly SWAGGER = new Tag('Swagger', '#355158');
    static readonly GCP = new Tag('GCP', '#192129');
